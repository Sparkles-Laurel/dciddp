	...
	return []Route{
		{
			...
			http.MethodPost,
			"/system",
			handleFunctions.DefaultAPI.CreateSystem,
		},
		{
			"SystemSystemFrontersGet",
			http.MethodGet,
			"/system/:system/fronters",
			handleFunctions.DefaultAPI.GetSystemFronters,
		},
		{
			"SystemSystemFrontersPut",
			http.MethodPut,
			"/system/:system/fronters",
			handleFunctions.DefaultAPI.PutFronters,
		},
		{
			"SystemSystemGet",
			http.MethodGet,
			"/system/:system",
			handleFunctions.DefaultAPI.GetSpecificSystem,
		},
		{
			"SystemSystemMemberMemberGet",
			http.MethodGet,
			"/system/:system/member/:member",
			handleFunctions.DefaultAPI.GetSystemMember,
		},
		{
			"SystemSystemMemberMemberPronounsGet",
			http.MethodGet,
			"/system/:system/member/:member/pronouns",
			handleFunctions.DefaultAPI.GetMemberPronouns,
		},
		{
			"SystemSystemMembersPost",
			http.MethodPost,
			"/system/:system/members",
			handleFunctions.DefaultAPI.CreateMember,
		},
	}
}
